...
interface EditCategoryModalProps {
  ...
  onClose: () => void;
  onUpdate: (values: { id: number; name: string; nameUzb: string }) => void;
}
  ...
  return (
    <div style={styles.overlay}>
      <div style={styles.modal}>
        ...
        <h2 style={styles.title}>Редактировать категорию</h2>
        ...
        <button onClick={handleSubmit} style={styles.updateButton}>Обновить</button>
      </div>
    </div>
  );
}
